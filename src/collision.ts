...
export default class Collision {
  ...
  addCollisionProperties(sprite: PIXI.Sprite) {
    ...
    if (sprite.hitArea == this.PIXI.SHAPES.CIRC) {
  ...
  */
  ...
  movingCircleCollision(c1, c2, global = false) {
    ...
    let combinedRadii, overlap, xSide, ySide,
      ...
      s = { vx: 0, vy: 0, vxHalf: 0, vyHalf: 0, dx: 0, dy: 0, lx: 0, ly: 0, magnitude: 0 },
      p1A = { x: 0, y: 0 },
      p1B = { x: 0, y: 0 },
      p2A = { x: 0, y: 0 },
      p2B = { x: 0, y: 0 },
  ...
  */
  ...
  hit(a, b, react = false, bounce = false, global, extra = undefined) {
    ...
    let collision,
      aIsASprite = typeof a.parent !== "undefined",
      bIsASprite = typeof b.parent !== "undefined";
    ...
    function findCollisionType(a, b) {
      ...
      //`spriteVsArray`)
      let aIsASprite = typeof a.parent !== "undefined";
      let bIsASprite = typeof b.parent !== "undefined";
